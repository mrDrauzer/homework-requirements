...
def test_category_initialization(self):
    p1 = Product("Умная колонка Яндекс Станция Миди", "Оранжевый", 10990.00, 7)
    p2 = Product("Смарт-часы Apple Watch Series 9", "GPS, 41 мм, алюминий", 39990.00, 12)
    p3 = Product("Беспроводные наушники Sony WH-1000XM5", "Черные", 29990.00, 20)
    category = Category("Электроника", "Популярные устройства", [p1, p2, p3])
...
def test_product_count_increment(self):
    ...
    products = [
        Product("Игровой ноутбук ASUS ROG Strix G16", "16”, Intel Core i7, 16ГБ, 512ГБ SSD", 129990.00, 5),
        Product("Телевизор Samsung Crystal UHD 4K 55\"", "Smart TV, 2024", 59990.00, 8)
    ]
